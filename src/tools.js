...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        ref: { type: "string", pattern: "^@?e\\d+$", examples: ["@e12"], description: "A ref from session_snapshot, such as @e12, used instead of selector" },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        format: { type: "string", enum: ["png", "jpeg"], default: "png", description: "png (default, lossless) or jpeg (smaller, and the only format quality applies to)" },
        quality: { type: "integer", minimum: 0, maximum: 100, description: "JPEG quality from 0 to 100; ignored for png" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        timeoutMs: { type: "integer", minimum: 1, default: 10000, description: "Maximum wait in milliseconds (default 10000)" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ["domain"],
      properties: {
        domain: { type: "string", examples: ["github.com"], description: "Domain the credentials are saved for, such as \"github.com\"" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        maxEvents: { type: "integer", minimum: 1, default: 10000, description: "Maximum events to keep, oldest dropped first (default 10000)" },
      },
      additionalProperties: false,
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: { type: "integer", minimum: 1, default: 100, description: "Maximum events to return in this page (default 100)" },
        offset: { type: "integer", minimum: 0, default: 0, description: "Number of events to skip, for paging through a long recording (default 0)" },
      },
      additionalProperties: false,
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        speed: { type: "number", exclusiveMinimum: 0, default: 1, description: "Replay speed multiplier; 1 is the recorded pace, 2 is twice as fast (default 1)" },
      },
      additionalProperties: false,
    },
  },
...
/**
 * A definition as the protocol defines it.
 *
 * `requiresExtension` is ours: it drives the published counts and the capability tests,
 * and it has no meaning in the MCP `Tool` interface. Returning it from `tools/list` puts a
 * field on the wire that no client asked for and none can interpret, so it is stripped
 * here rather than being kept out of the registry, where it earns its place.
 */
export function toWireTool({ requiresExtension, ...tool }) {
  return tool;
}
